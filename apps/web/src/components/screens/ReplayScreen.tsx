...
const BRANCHES = [
  {
    ...
    label: "main",
    color: "var(--amber)",
    events: [0, 2, 4, 6, 8, 10, 12],
    current: true,
  },
  {
    id: "b1",
    label: "branch · inject TSMC fire",
    color: "var(--p-2)",
    events: [4, 6, 8],
    current: false,
  },
  {
    id: "b2",
    label: "branch · swap Lai → Hou Yu-ih",
    color: "var(--p-4)",
    events: [2, 4, 6, 8],
    current: false,
  },
          ...
          <div className="grow row" style={{ overflow: "hidden" }}>
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        ...
                        <span
                          style={{ color: p.colorVar, fontSize: 11, fontWeight: 600 }}
                        >
                          {p.name}
                        </span>
            ...
            <div className="grow col">
              <SectionHeader
                ...
                sub={`turn ${scrub} · diverged at turn 4`}
              />
              <div className="grow" style={{ overflowY: "auto", padding: 16 }}>
                <div
                  style={{
                ...
                >
                  ...
                  <div style={{ fontSize: 11, color: "var(--ink-0)", marginTop: 4 }}>
                    &quot;Hsinchu Fab 18 fire reported, 6h estimated downtime, lithography section
                    affected&quot;
                  </div>
                </div>
                <div

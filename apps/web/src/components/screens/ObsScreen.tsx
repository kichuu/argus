      ...
      <ScreenHeader
        ...
        right={
          <div className="row gap-2">
            <Segmented size="sm" options={["1h", "24h", "7d", "30d"] as const} value={range} onChange={setRange} />
      ...
      <div className="grow" style={{ overflowY: "auto", padding: 16 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
          ...
          <Panel id="W" title="Workflows" sub="temporal · running">
            ...
            >
              <div>
                <span className="green">▸</span> deliberation_v3 · d-2026-04-25-01 · turn 13/14 ·
                running 1m 34s
              </div>
              <div>
          ...
          <Panel id="P" title="Prompt Diffs (DSPy)" sub="auto-tuning history">
            ...
            >
              <div>
                <span className="muted">2026-04-24 18:02</span> ·{" "}
                <span className="green">+0.04</span> consensus quality · orchestrator.cast_personas
                · v.42
              </div>
              <div>
                <span className="muted">2026-04-23 09:14</span> ·{" "}
                <span className="green">+0.02</span> citation rate · persona.synthesize · v.31
              </div>
              <div>
                <span className="muted">2026-04-22 22:48</span> ·{" "}
                <span className="red">−0.01</span> rolled back · persona.challenge · v.18
              </div>
              <div>
                <span className="muted">2026-04-21 11:30</span> ·{" "}
                <span className="green">+0.06</span> minority capture · synthesizer · v.27
              </div>
            </div>
          </Panel>

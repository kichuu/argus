...
def _build_retriever() -> Any:
    """Construct the default HybridRetriever from configured deps.

    Imported lazily so unit tests can patch `argus_retrieval` symbols and so
    the activity import path doesn't pull heavy ML deps at module load.
    """
